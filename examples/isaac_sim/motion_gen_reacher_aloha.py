...
parser.add_argument("--robot", type=str, default="aloha_v1_1arm.yml", help="robot configuration to load")
parser.add_argument(
    "--external_asset_path",
    type=str,
    default=None,
...
def main():
    ...
    target = cuboid.VisualCuboid(
        "/World/target",
        position=np.array([0.02368, 0.49026, 0.42389]),
    ...
    while simulation_app.is_running():
        ...
        if step_index % 100 == 0:
            print("Step", step_index, "Joint positions:", sim_js.positions)
